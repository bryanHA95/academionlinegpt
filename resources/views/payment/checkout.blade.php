    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8 py-12">
        ...
        <div class="card text-gray-600">
            <div class="card-body">
                ...
                <p class="text-sm mt-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Vel distinctio aut quisquam ipsum dolores, atque quos deleniti esse, reprehenderit repellat omnis natus dicta totam! Recusandae, sint. Reprehenderit soluta quasi dolor. <a class="text-red-500 font-bold" href="">Terminos y Condiciones</a></p>
