    ...
    <article class="card">
        <div class="card-body bg-gray-100">
            <form wire:submit.prevent="store">
                <input wire:model="name" class="form-input w-full" placeholder="Ingrese un objetivo">
                ...
                <div class="flex justify-end mt-2">
                    <button type="submit" class="font-bold py-2 px-4 rounded bg-blue-500 text-white hover:bg-blue-700">Agregar Objetivo</button>
                </div>
            </form>
        </div>
    </article>
