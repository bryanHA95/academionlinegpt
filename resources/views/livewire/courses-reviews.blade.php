<section class="mt-4">
    <h1 class="font-bold text-3xl text-gray-600 mb-2">Valoración</h1>

    @can('enrolled', $course)
        <article class="mb-4">

            @can('valued', $course)
                <textarea wire:model="comment" class="form-input w-full" rows="3" placeholder="Agregar un comentario"></textarea>

                <div class="flex items-center">
                    <button class="btn btn-primary mr-2" wire:click="store">Publicar</button>
            ...
            @else
                <div class="flex items-center bg-blue-500 text-white text-sm font-bold px-4 py-3" role="alert">
                    ...
                    <p>Usted ya ha publicado su reseña.</p>
                </div>
            @endcan  
        </article>
    @endcan
    ...
    <div class="card mt-4">
        <div class="card-body">
            <p class="text-gray-800 text-xl mb-4"><strong>({{$course->reviews->count()}}) Valoraciones</strong></p>
